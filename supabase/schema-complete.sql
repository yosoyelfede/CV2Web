-- CV2W Complete Database Schema
-- This file handles both new installations and existing databases
...
-- DROP TABLE IF EXISTS cv_documents CASCADE;
...
DROP INDEX IF EXISTS idx_cv_documents_status;
DROP INDEX IF EXISTS idx_cv_data_document_id;
...
DROP POLICY IF EXISTS "Users can insert CV data for their documents" ON cv_data;
